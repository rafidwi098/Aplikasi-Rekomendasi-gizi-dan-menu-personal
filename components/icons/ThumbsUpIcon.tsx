...
export const ThumbsUpIcon: React.FC<{ active?: boolean; className?: string }> = ({ active, className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className || "h-7 w-7"}
    viewBox="0 0 24 24"
    fill={active ? '#22c55e' : 'currentColor'} // Menggunakan emerald-500 untuk konsistensi
  >
